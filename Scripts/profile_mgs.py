...
ax.plot(MAX_GRID_SIZES, runtimes_mhm, label="MHM, 32 ranks")

#
# IMEX
#
PROFILE_LOG_DIR = "/home/bendp/practicals/remote_results/cerberus3-mgs-pesk/"
NAME_FMT = "M1-PESK-MUSCL-SSP222-{MAX_GRID_SIZE}-1024.8.1.?"
MAX_GRID_SIZES = [8, 16, 32, 64, 128, 256]
